...
# Solution essentially uses the instructions above (as stirling numbers involve a complex 
# computation), returns 1 or 0 for the base cases, and recursively calls itself to compute
# S(n, k) = k*S(n-1, k) + S(n-1, k-1) down to the base case. 
...
# Computing a bell number requires the computation of a stirling number as well.

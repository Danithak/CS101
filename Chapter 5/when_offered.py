...
def when_offered(courses,course):			# Takes a list of courses and a course of interest
    x = []									# and returns a list showing when the courses are available
    for i in courses:						# or an empty list if the course is not offered.
